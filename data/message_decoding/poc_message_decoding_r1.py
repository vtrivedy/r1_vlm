...
def generate_r1_messages(example):
    ...
    # split the messages with a space between each character (to prevent tokenization issues)
    ...
    ending = 'Show your work in <think> </think> tags and return the answer in <answer> </answer> tags, for example <answer> "A B C" </answer>.'
