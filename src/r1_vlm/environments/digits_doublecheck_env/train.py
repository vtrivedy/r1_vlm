...
from r1_vlm.environments.digits_doublecheck_env.digits_doublecheck_env import (
    DigitsDoubleCheckEnv,
)

os.environ["WANDB_ENTITY"] = "groundlightai"
os.environ["WANDB_PROJECT"] = "digits-doublecheck"
...
vf_env = DigitsDoubleCheckEnv(processing_class=processor)
...
training_args = GRPOConfig(
    ...
    output_dir="vlm-r1-digits-doublecheck",
    learning_rate=1e-6,
    adam_beta2=0.98,
